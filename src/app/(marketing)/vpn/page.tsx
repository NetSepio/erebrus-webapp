...
const features = [
  ...
  { glyph: "✦", title: "Earn as operator", desc: "Run a node, track peers and uptime, earn XP daily." },
  { glyph: "◈", title: "Private org nodes", desc: "Hide nodes behind your workspace — visible only to members." },
];
      ...
      <section className="mx-auto grid max-w-[1180px] items-center gap-12 px-4 py-16 md:grid-cols-2 md:px-8 md:py-20">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-3.5">
            ...
            <Link href="/#operators">
              <AccentButton variant="ghost" className="!px-6 !py-4">Run a node</AccentButton>
            </Link>
          </div>
          <p className="mt-5 font-mono text-xs text-[var(--text-3)]">7-day free trial · no card</p>
        </div>
      ...
      <section id="how" className="mx-auto max-w-[1180px] px-4 pb-20 md:px-8">
        <Card className="p-10 text-center">
          ...
          <p className="mx-auto mt-3 max-w-md text-[var(--text-2)]">
            Launch the app, start your trial, and pick a node in under a minute.
          </p>
          <AuthModalTrigger>
            <AccentButton className="mt-6">Launch app →</AccentButton>
          </AuthModalTrigger>
        </Card>
      </section>
